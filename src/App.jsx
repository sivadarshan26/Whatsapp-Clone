...
const App = () => {
  ...
  return (
    <div className="bg-gray-950 flex p-3 max-h-full overflow-hidden ">
      <div className="w-[54px] bg-custom2 pt-4 flex flex-col items-center border-r border-gray-700">
        <div className="flex-row justify-center">
          <div
            className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] cursor-pointer"
            tabIndex={0}
          >
          ...
          <div className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] mt-3">
            <HiUserGroup className="search-icon " size={24} />
          </div>

          <div className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] mt-3">
            <BsChatDots className="search-icon " size={24} />
          </div>

          <div className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] mt-3">
            <PiBracketsRoundDuotone className="search-icon " size={26} />
          </div>

          <hr className=" mt-5 border-b-[0.5px] border-gray-500" />

          <div className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] mt-3">
            <AiOutlineStar className="search-icon " size={26} />
          </div>
        </div>
        <div id="bottom" className="mt-auto flex flex-col items-center">
          <div className="rounded-full hover:bg-gray-600 hover:bg-opacity-50 focus:bg-gray-600 flex items-center justify-center w-[40px] h-[40px] mt-3 mb-3">
            <IoSettingsOutline className="search-icon" size={26} />
          </div>
          <div
            id="a"
            className="rounded-full bg-purple-300 cursor-pointer mb-4"
            onClick={handleClick}
          >
            <img
          ...
          <div className="bg-gray-400 h-16 items-center flex  ">
            <div className="basis-1/3 h-full bg-custom3 flex justify-between items-center p-2 border-r border-gray-700">
              {isClicked ? (
                <div className="flex justify-between w-full">
                  <h6 className="ml-2 text-[22px] text-white font-bold">
                    Chats
                  </h6>
            ...
            <div className="grow h-full justify-between items-center bg-custom2 flex p-2 ">
              <div id="top right" className="flex items-center">
                <div
                  className="circular-image bg-purple-300 cursor-pointer "
              ...
              <div className="flex space-x-4 items-center">
                <div
                  className="flex items-center border border-gray-700 rounded-full px-2 py-1"
                  onClick={VideoDiv}
                >
                  <PiVideoCameraFill
                    className="text-gray-700 ml-1 mr-1.5"
                    size={24}
                  />
            ...
            <div className="h-screen basis-1/3 pt-2 p-3 relative border-r overflow-y-auto border-gray-700 bg-custom3">
              ...
              {filterClicked && (
                <div className="h-20 ml-3 mr-10 items-center border-b custom-border flex">
                  <p className="text-green-500 text-lg self-center">
                    Filtered by Unread
                  </p>
                </div>
              )}
              ...
              {isClicked ? (
                <Profilediv
                  updateProfileImage={updateProfileInfo}
                  profileImage={profileImage}
                />
              ) : (
                <div className="flex flex-col items-center">
                  <p className="pl-1 pt-2 text-[22px] self-start text-white font-bold">
                    Profile
                  </p>
                  <div
                    id=""
                    className="rounded-full bg-purple-300 cursor-pointer mt-4 mb-4"
                    onClick={handleClick}
                  >
                    <img
                      src={mainProfileImage}
                  ...
                  <p className="font-[14px] text-[#008069] self-start">
                    Your name
                  </p>
                  <div className="flex w-full justify-between">
                    <p className="font-[16px] font-thin self-start text-[#d1d7db]">
                      darshan ❤
                    </p>
                  ...
                  <p className="font-[14px] text-[#008069] self-start mt-5">
                    About
                  </p>
                  <p className="font-[16px] font-thin self-start text-[#d1d7db] mt-4">
      ...
      {isDivOpen && (
        <div className="sticky   bg-gray-400 w-1/3 border-l border-gray-700">
          ...
          <div className="bg-[#030712] max-h-screen overflow-y-auto">
            <div
              id="side"
              className="bg-[#111B21] p-10 mb-2 flex flex-col items-center justify-center"
            >
              <img
            ...
            <div className="bg-[#202c33] px-8 py-4 mb-2 flex flex-col">
              ...
              <p className="text-white">
                Go to war against the man in the mirror & don't come back until
                you win!
              </p>
            </div>
              ...
              <div className="flex justify-between">
                <div className=" flex">
                  ...
                  <div className="ml-1">
                    ...
                    <p className="search-icon text-xs">
                      Messages are end-toendencrypted. Click to verify.
                    </p>
                  </div>
                </div>
